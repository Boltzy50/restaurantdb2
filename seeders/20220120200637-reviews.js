  ...
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert("reviews", [
      ...
      },
      {
        ...
        review:
          "Great food! Great service! One of my favorite steak houses.  I love a good lobster bisque and with Bones you can taste the sherry. The baby octopus salad with sherry was incredible. The sherry vinaigrette was light and flavorful.",
        stars: 5,
        restaurantid: 1,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      },
      {
        name: "Faith M",
        review:
          "We had brunch at South City Kitchen Buckhead last Saturday. The food was delicious. Emmanuel, our waiter, was outstanding and his recommendations were spot on. The Shrimp and Grits entree was so hearty and full of flavor.",
        stars: 5,
        restaurantid: 2,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      },
      {
        name: "Yas M",
        review:
          "If the Michelin guide rated Atlanta restaurants this place would surely have a star. Stunning plates and absolutely delicious. Wonderful attentive service. Easily one of the best restaurants in the city.",
        stars: 5,
        restaurantid: 3,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      },
      {
        name: "Diane Raschke",
        review:
          "This was a very pleasant 1st time dining experience. The view from our table was magnificent and the atmosphere was quiet while not stuffy.",
        stars: 5,
        restaurantid: 6,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      },
      {
        name: "L Smith",
        review:
          "Great little treasure we discovered while walking around Grant Park. Service was great in a very chill environment. Southern tots were fantastic!  Also very tasty were the chicken sliders!",
        stars: 5,
        restaurantid: 8,
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      },
      {
        name: "Collette Alex",
        review:
          "Let me first start off by saying we absolutely love this place and have been going there for the past seven years. Their food is good and I don’t have a complaint about the taste and quality of their food.",
        stars: 4,
        restaurantid: 9,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        name: "Rhett Wilkins",
        review:
          "Always amazing and quality control is top notch. Best pho in ATL, hands down. Keep it up! Com bo luc lac and pho ga are my go-to and they never cease to amaze me.",
        stars: 5,
        restaurantid: 9,
        createdAt: new Date(),
        updatedAt: new Date(),
